...
const dataTableImage = [
  ...
  {
    id: 4,
    image: DemoSmallNavigate,
    desc: "Click to make the navigation smaller.",
  },
  {
    id: 5,
    image: DemoBigNavigate,
    desc: "Click to make the navigation bigger.",
  },
  {
    id: 6,
  ...
  return (
    ...
    >
      ...
      <table style={{ margin: "20px 0" }}>
        ...
        <tr>
          <td style={trCss}>
            <OptionButton>Setting</OptionButton>
          </td>
          <td>
            <TextDesc>Click to change your screen settings.</TextDesc>
          </td>
        </tr>
        <tr>
          <td style={trCss}>
